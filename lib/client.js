...
window.__ModuleLoader__.load({ id: '@sanqi-normal/dsh-webui-market-plugin', factory: (require) => {
  ...
  const STR = {
    ...
    en: {
      ...
      autoSync: 'Auto-sync to other profiles after install (on by default)',
  ...
  function MarketPanel() {
    ...
    return h('div', { className: 'mkts' },
      ...
      profiles && profiles.length > 1 ? h('div', { className: 'mkts-sync' },
        h('div', { className: 'mkts-sec' }, t('settingsTitle')),
        h('div', { className: 'mkts-hint' }, t('settingsHint')),
        ...
        h('div', { className: 'mkts-sec', style: { marginTop: 12 } }, t('syncTitle')),
