...
window.__ModuleLoader__.load({ id: '@sanqi-normal/dsh-webui-market-plugin', factory: (require) => {
  ...
  const STR = {
    zh: {
      ...
      queueTitle: '任务队列', queueProgress: '共 {total} 项 · {active} 项进行中/排队', log: '日志', clearTask: '清除', cancelQueued: '取消排队', recentTasks: '最近任务',
    ...
    en: {
      ...
      queueTitle: 'Task queue', queueProgress: '{total} total · {active} active/queued', log: 'Log', clearTask: 'Clear', cancelQueued: 'Cancel', recentTasks: 'Recent tasks',
